            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select wire:model="selectedCourseId" id="course" class="form-select" @if(!$selectedClassId) disabled @endif>
                            <option value="">@if($courses->count() > 0) Select Course @else Select a program first @endif</option>
