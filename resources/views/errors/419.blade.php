...
<html lang="en">
<head>
    <title>Session Expired - {{ config('branding.institution.name', config('app.name')) }}</title>
    <meta charset="utf-8">
...
<body>
        ...
        <div class="glass-card">
            ...
            <div class="error-details">
                <p>
                    ...
                    This is a security measure to protect your account and personal information.
                </p>
            </div>
            ...
            <div id="countdown" class="countdown-text" style="display: none;">
                Redirecting to login in <span class="countdown-number" id="countdown-number">10</span> seconds...
            </div>
    ...
    <!-- Optional: Auto-redirect script (uncomment to enable) -->
    <script>
        // Uncomment the following code to enable auto-redirect after 10 seconds
        /*
        let countdown = 10;
