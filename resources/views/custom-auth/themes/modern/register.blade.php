...
<html lang="en">
<head>
    <title>{{ config('branding.institution.name', config('app.name')) }} - Register</title>
    <meta charset="utf-8">
    ...
    <div class="auth-container">
        ...
        <div class="glass-card">
            ...
            <div class="welcome-section">
                ...
                <p class="welcome-subtitle">Join our academic community</p>
            </div>
                    ...
                    <div class="form-group">
                        <div class="form-check">
                            <input class="form-check-input @error('terms') is-invalid @enderror" 
                                   ...
                                   id="terms" 
                                   required>
                            <label class="form-check-label" for="terms" style="color: rgba(255, 255, 255, 0.9); font-size: 0.8rem;">
                                {!! __('I agree to the :terms_of_service and :privacy_policy', [
                                        'terms_of_service' => '<a target="_blank" href="'.route('terms.show').'" style="color: white; text-decoration: underline;">'.__('Terms of Service').'</a>',
                                        'privacy_policy' => '<a target="_blank" href="'.route('policy.show').'" style="color: white; text-decoration: underline;">'.__('Privacy Policy').'</a>',
                                ]) !!}
                            </label>
                            @error('terms')
                                <div class="invalid-feedback">
            ...
            <div class="login-section">
                ...
                <div class="login-links">
                    <a class="login-link" href="{{ route('login') }}">Sign In</a>
                </div>
            </div>
        </div>
    </div>
