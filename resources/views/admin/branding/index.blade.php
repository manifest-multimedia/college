            ...
            <div class="card mb-8">
                ...
                <div class="alert alert-success d-flex align-items-center p-5 mb-8">
                    ...
                    <div class="d-flex flex-column">
                        <h4 class="mb-1 text-success">Individual Section Saves</h4>
                        <span>Each configuration section now has its own save button for better feedback and control.</span>
                    </div>
                </div>
        </div>
    </div>
