<div>
    <section data-from-ai="true">
        <div class="px-6 py-8">
            <div class="flex-wrap d-flex align-items-center justify-content-between">
                <div class="mb-4 col-12 col-lg-auto mb-lg-0">
                    <div class="d-flex align-items-center">
                        <h4 class="mb-0 me-2">Student Information</h4> <span
                            class="badge bg-primary rounded-pill small">{{ $studentsTotal }}</span>
                    </div>
                </div>
                <div class="col-12 col-lg-auto d-flex align-items-center">
                    <div class="bg-white rounded border input-group me-4 pe-4"> <input class="border-0 form-control"
                            type="text" placeholder="Type to search..."> <button class="p-0 btn" type="button">
                        ...
                        class="flex-shrink-0 btn btn-primary d-flex align-items-center me-2" href="#"> <span
                            class="d-inline-block me-2 text-primary-light"> <svg viewbox="0 0 16 16" fill="none"
                            ...
                            </svg> </span> <span>Import Students</span> </a> <a
                        class="flex-shrink-0 me-3 btn btn-secondary d-flex align-items-center" href="#"> <span
                            class="d-inline-block me-2"> <img
                                src="data:image/png;base64,"
                                width="16" height="16" alt="export icon"> </span> <span>Export
                            Students</span> </a>
                    <a class="flex-shrink-0 me-3 btn btn-secondary d-flex align-items-center" href="/generate"> <span
                            class="d-inline-block me-2"> <img
                                src="data:image/png;base64,"
                                width="16" height="16" alt="export icon"> </span> <span>Generate
                            Student IDs</span> </a>
                </div>
            </div>
        </div>
    ...
    <section data-from-ai="true" class="py-8">
        <div class="container">
                    ...
                    <table class="table mb-0 table-borderless table-striped small">
                        <thead>
                            <tr class="text-secondary">
                                <th class="px-6 pt-4 pb-3">Student ID</th>
                                <th class="px-6 pt-4 pb-3">Student Name</th>
                                <th class="px-6 pt-4 pb-3">Program</th>
                                <th class="px-6 pt-4 pb-3">Cohort</th>
                                <th class="px-6 pt-4 pb-3">Status</th>
                                <th class="px-6 pt-4 pb-3">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            @foreach ($students as $student)
                                <tr>
                                    <td class="px-6 py-5">{{ $student->student_id }}</td>
                                    <td class="px-6 py-3">
                                        <div class="d-flex align-items-center">
                                            @if ($student->profile_photo_url)
                                                <img class="rounded me-4 img-fluid"
                                                    src="{{ $student->profile_photo_url }}" alt="avatar"
                                                    style="width: 32px; height: 32px;">
                                            @endif
                                            <div>
                                                <p class="mb-0">
                                                    {{ ($student->last_name ? $student->last_name : '') . ($student->first_name ? ' ' . $student->first_name : '') . ($student->other_name ? ' ' . $student->other_name : '') }}
                                                </p>
                                                <p class="mb-0 text-secondary">{{ $student->email }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-5"> {{ $student->CollegeClass()->first()->name }} </td>
                                    <td class="px-6 py-5"> {{ $student->Cohort()->first()->name ?? '' }} </td>
                                    <td class="px-6 py-5"> <span
                                            class="badge bg-success">{{ $student->status ?? '' }}</span> </td>
                                    <td class="px-6 py-5"> <a class="p-0 btn me-2" href="#"> <svg width="18"
                                        ...
                                        {{-- <a class="p-0 btn me-2" href="#"> <svg width="18"
                                                height="18" viewbox="0 0 18 18" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                        ...
                                        <a class="p-0 btn" href="#"> <svg width="20" height="20"
                                ...
                                </tr> <!-- Additional rows would follow the same pattern -->
                            @endforeach
                        </tbody>
                    </table>

                </div>
            </div> <!-- Pagination section remains unchanged -->
            {{ $students->links() }}
        </div>
    </section>
</div>
