  ...
  @if($errors->any() || session()->has('error') || session()->has('message'))
    ...
    @endif
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="examPassword" placeholder="Enter your Exam Password" required wire:model.live="examPassword">
        </div>
            <button wire:click="startExam" class="btn btn-primary w-100" type="submit">Start Exam</button>
        {{-- </form> --}}
    </div>
</div>