<x-dashboard.default title="Manage Questions" pageActions="question-sets-questions">
    <!--begin::Main-->
                        ...
                        <div class="card-header border-0 pt-6">
                            <div class="card-title">
                                <div class="d-flex align-items-center position-relative my-1">
                                    <span class="fs-4 fw-bold text-gray-800">Add, edit, delete, and organize questions in this question set</span>
                                </div>
                            </div>
                        </div>
                        <div class="card-body pt-0">
                            @livewire('question-bank', ['mode' => 'manage_questions', 'questionSetId' => $id])
                        </div>
                    </div>
                </div>
