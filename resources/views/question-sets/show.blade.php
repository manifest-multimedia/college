<x-dashboard.default title="Question Set Details" pageActions="question-sets-show">
    <!--begin::Main-->
                        ...
                        <div class="card-header border-0 pt-6">
                            <div class="card-title">
                                <div class="d-flex align-items-center position-relative my-1">
                                    <span class="fs-4 fw-bold text-gray-800">View and manage question set information and questions</span>
                                </div>
                            </div>
                        </div>
