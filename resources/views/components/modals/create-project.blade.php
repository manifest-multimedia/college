            ...
            <div class="modal-content">
                ...
                <div class="modal-header header-bg">
                    ...
                    <h2 class="text-white">New Project
                        <small class="text-white opacity-50 ms-2 fs-7 fw-normal">Create, Edit, Manage projects</small>
                    </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
                    <div class="btn btn-sm btn-icon btn-color-white btn-active-color-primary"
                ...
                <div class="m-5 modal-body scroll-y">
                    ...
                    <div class="stepper stepper-links d-flex flex-column" id="kt_modal_create_project_stepper">
                        ...
                        <div class="container">
                            ...
                            <!--end::Nav-->
                            <!--begin::Form-->
                            <form class="pb-10 mx-auto w-100 mw-600px pt-15" novalidate="novalidate"
                                ...
                                <div class="current" data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-7 pb-lg-12">
                                            <!--begin::Title-->
                                            <h1 class="text-gray-900 fw-bold">Project Type</h1>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="fv-row mb-15" data-kt-buttons="true">
                                            ...
                                            <label
                                                ...
                                                <span class="d-flex">
                                                    ...
                                                    <!--begin::Info-->
                                                    <span class="ms-4">
                                                        <span class="mb-2 text-gray-900 fs-3 fw-bold d-block">Team
                                                            Project</span>
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-12">
                                            <!--begin::Title-->
                                            <h1 class="text-gray-900 fw-bold">Project Settings</h1>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <div class="text-muted fw-semibold fs-4">If you need more info, please
                                                check
                                        ...
                                        <div class="mb-8 fv-row">
                                            ...
                                            <div class="dropzone" id="kt_modal_create_project_settings_logo">
                                                ...
                                                <div class="dz-message needsclick">
                                                    ...
                                                    <!--begin::Info-->
                                                    <div class="ms-4">
                                                        <h3 class="mb-1 text-gray-900 dfs-3 fw-bold">Drop files here
                                        ...
                                        <div class="mb-8 fv-row">
                                            <!--begin::Label-->
                                            <label class="mb-2 required fs-6 fw-semibold">Project Description</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                        ...
                                        <div class="mb-8 fv-row">
                                            <!--begin::Label-->
                                            <label class="mb-2 required fs-6 fw-semibold">Release Date</label>
                                            <!--end::Label-->
                                            <!--begin::Wrapper-->
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-10 pb-lg-12">
                                            <!--begin::Title-->
                                            <h1 class="text-gray-900 fw-bold">Budget</h1>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <div class="text-muted fw-semibold fs-4">If you need more info, please
                                                check
                                        ...
                                        <div class="mb-8 fv-row">
                                            ...
                                            <div class="position-relative w-lg-250px"
                                                ...
                                                <!--begin::Input control-->
                                                <input type="text"
                                                    class="border-0 form-control form-control-solid ps-12"
                                            ...
                                            <div class="row g-9" data-kt-buttons="true"
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xxl-6">
                                                    ...
                                                    <label
                                                        ...
                                                        <span class="ms-5">
                                                            <span
                                                                class="mb-2 text-gray-800 fs-4 fw-bold d-block">Precise
                                                                Usage</span>
                                                            <span class="text-gray-600 fw-semibold fs-7">Withdraw
                                                ...
                                                <div class="col-md-6 col-lg-12 col-xxl-6">
                                                    ...
                                                    <label
                                                        ...
                                                        <span class="ms-5">
                                                            <span
                                                                class="mb-2 text-gray-800 fs-4 fw-bold d-block">Extreme
                                                                Usage</span>
                                                            <span class="text-gray-600 fw-semibold fs-7">Withdraw
                                                                money to your bank account per transaction under $50,000
                                                                budget</span>
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-12">
                                            <!--begin::Title-->
                                            <h1 class="text-gray-900 fw-bold">Build a Team</h1>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <div class="text-muted fw-semibold fs-4">If you need more info, please
                                                check
                                        ...
                                        <div class="mb-8">
                                            <!--begin::Label-->
                                            <label class="mb-2 fs-6 fw-semibold">Invite Teammates</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid"
                                        ...
                                        <div class="mb-8">
                                            <!--begin::Label-->
                                            <div class="mb-2 fs-6 fw-semibold">Team Members</div>
                                            <!--end::Label-->
                                            <!--begin::Users-->
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-12">
                                            <!--begin::Title-->
                                            <h1 class="text-gray-900 fw-bold">Set First Target</h1>
                                            <!--end::Title-->
                                            <!--begin::Title-->
                                            <div class="text-muted fw-semibold fs-4">If you need more info, please
                                                check
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-8 fv-row">
                                            <label class="mb-2 fs-6 fw-semibold">Target Title</label>
                                            <input type="text" class="form-control form-control-solid"
                                        ...
                                        <div class="mb-8 row g-9">
                                            ...
                                            <div class="col-md-6 fv-row">
                                                <label class="mb-2 required fs-6 fw-semibold">Assign</label>
                                                <select class="form-select form-select-solid" data-control="select2"
                                            ...
                                            <!--begin::Col-->
                                            <div class="col-md-6 fv-row">
                                                <label class="mb-2 required fs-6 fw-semibold">Due Date</label>
                                                <div class="position-relative d-flex align-items-center">
                                                    <!--begin::Icon-->
                                                    <i class="mx-4 ki-duotone ki-calendar-8 fs-2 position-absolute">
                                                        <span class="path1"></span>
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-8 fv-row">
                                            <label class="mb-2 fs-6 fw-semibold">Target Details</label>
                                        ...
                                        <!--begin::Input group-->
                                        <div class="mb-8 fv-row">
                                            <label class="mb-2 required fs-6 fw-semibold">Tags</label>
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="mb-8">
                                            ...
                                            <div class="mh-300px scroll-y me-n7 pe-7">
                                                <!--begin::File-->
                                                <div
                                                    class="py-4 border border-dashed d-flex flex-stack border-top-0 border-left-0 border-right-0">
                                                    <div class="d-flex align-items-center">
                                                        <!--begin::Avatar-->
                                                        ...
                                                        <div class="ms-6">
                                                            <a href="#"
                                                                class="mb-2 text-gray-900 fs-5 fw-bold text-hover-primary">Avionica
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-6">
                                                            <a href="#"
                                                                class="mb-2 text-gray-900 fs-5 fw-bold text-hover-primary">9
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-6">
                                                            <a href="#"
                                                                class="mb-2 text-gray-900 fs-5 fw-bold text-hover-primary">User
                                                                CRUD Styles</a>
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-6">
                                                            <a href="#"
                                                                class="mb-2 text-gray-900 fs-5 fw-bold text-hover-primary">Design
                                                                Initial Logo</a>
                                                ...
                                                <div class="py-4 d-flex flex-stack">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="ms-6">
                                                            <a href="#"
                                                                class="mb-2 text-gray-900 fs-5 fw-bold text-hover-primary">Tower
                                                                Hill Bilboard</a>
                                ...
                                <div data-kt-stepper-element="content">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <div class="pb-12 text-center">
                                            <!--begin::Title-->
                                            <h1 class="text-gray-900 fw-bold">Project Created!</h1>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <div class="text-muted fw-semibold fs-4">If you need more info, please
