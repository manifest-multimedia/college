...
<head>
    <base href="../" />
    <title>360College Management System &mdash; {{ $title ? $title : 'Dashboard' }}</title>
    <meta charset="utf-8" />
    ...
    <link href="{{ asset('dashboard/assets/plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('dashboard/assets/plugins/custom/vis-timeline/vis-timeline.bundle.css') }}" rel="stylesheet"
        type="text/css" />
