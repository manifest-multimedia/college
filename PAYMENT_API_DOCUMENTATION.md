  ...
  "bills": [
    {
      ...
      "bill_public_reference": "BILL-01K4M7X9Q2R8N6T5",
      ...
      "items": [
        {
          "item_reference": "FEE-01K4M8A4P5Q1J7R9",
        ...
        {
          "item_reference": "FEE-01K4M8B9Z7Y2N3Q1",
...
| :--- | :--- | :--- | :--- |
| `student_fee_bill_item_reference` | String | Yes | The public reference of the specific fee item being paid (e.g. `FEE-01K4M8A4P5Q1J7R9`). Prefer this over numeric IDs. |
| `student_fee_bill_item_id` | Integer | Deprecated | Legacy numeric DB id (still accepted for backward compatibility). Prefer `student_fee_bill_item_reference`. |
...
```json
{
  "student_fee_bill_item_reference": "FEE-01K4M8A4P5Q1J7R9",
  "amount": 350.00,
  ...
  try {
    ...
    if (tuitionItem.balance > 0) {
      ...
      const paymentResponse = await axios.post(`${apiBase}/v1/payments/pay-item`, {
        student_fee_bill_item_reference: tuitionItem.item_reference || tuitionItem.id,
